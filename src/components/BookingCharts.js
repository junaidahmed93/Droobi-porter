    ...
    return (
      <div >
        <div className="lineChart" >
          <h3 className="BookingGraphHeading">Ambulance total distance</h3>
          <LineChart
            width={730}
            height={300}
          ...
          >
            ...
            <YAxis label={{ value: 'Distance in meters', angle: -90, position: 'insideBottomLeft' }} />
            <Tooltip />
            <Legend />
        ...
        <div className="vl" />
        <div className="lineChart" >
          <h3 className="BookingGraphHeading">Total Pickups</h3>
          <PieChart
            width={350}
            height={300}
            margin={{
